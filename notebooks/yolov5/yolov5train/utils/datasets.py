...
def create_dataloader(path, imgsz, batch_size, stride, opt, hyp=None, augment=False, cache=False, pad=0.0, rect=False, drop_last=True):
    ...
    dataloader = torch.utils.data.DataLoader(dataset,
                                             ...
                                             num_workers=nw,
                                             pin_memory=True,
                                             collate_fn=LoadImagesAndLabels.collate_fn, drop_last=drop_last)
